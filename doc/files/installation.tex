...
The directory structure is shown in Fig. \ref{fig:directorystructure}. As stated above, for the remainder of this manual, {\tt \$\{SMOOTH\_HOME\}/}, {\tt \$\{MY\_LOCAL\}/} and {\tt \$\{MY\_ANALYSIS\}/} will be used to denote the location of these directories. 
