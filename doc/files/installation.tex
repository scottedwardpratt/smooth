...
Within the repository, there will be a directory\\{\tt /Users/CarlosSmith/bandframework/software/SmoothEmulator/}. All the relevant functionality of {\it Smooth Emulator} is contained within this directory. Throughout the manual the phrase {\tt \$\{SMOOTH\_HOME\}} will refer to this directory. 

The User should create a personal directory from which the User would perform a project. This is easiest accomplished by copying the analysis template directory from the {\it Smooth} distribution. For example
\vspace*{-12pt}{\tt \begin{Verbatim}[commandchars=\\\{\}]
...
The directory structure is Fig. \ref{fig:directorystructure}. As stated above, for the remainder of this manual, {\tt \$\{SMOOTH\_HOME\}/}, {\tt \$\{MY\_LOCAL\}/} and {\tt \$\{MY\_ANALYSIS\}/} will be used to denote the location of these directories. 
...
\vspace*{-12pt}{\tt \begin{Verbatim}[commandchars=\\\{\}]
% \textcolor{darkred}{export EIGEN3_INCLUDE_DIR=/usr/local/include/eigen3}
\end{Verbatim}
}\vspace*{-12pt}
...
{\tt \$\{MY\_LOCAL\}/software/CMakeLists.txt}, and replace the line where the variable {\tt \$\{SMOOTH\_HOME\}} is set to the shell's environmental variable with one where it is set explicitly.
...
% \textcolor{darkred}{$\{MY_LOCAL\}/software% cmake .}
% \textcolor{darkred}{$\{MY_LOCAL\}/software% make}
    .
    .
\end{Verbatim}
}\vspace*{-12pt}
...
{\tt \$\{MY\_LOCAL\}/software/MainPrograms/}. If you build your own main programs (probably using these as examples), you can edit the {\tt CMakeList.txt} file in {\tt \$\{MY\_LOCAL\}/software/MainPrograms/}, using the existing entries as an example. The executables should appear in {\tt \$\{MY\_LOCAL\}/bin/}. 
