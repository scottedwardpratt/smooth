...
{\tt
\begin{verbatim}
    % cp -r ${SMOOTH_HOME}/AnalysisTemplate /Users/CarlosSmith/MY_ANALYSIS
\end{verbatim}
}
...
{\tt
\begin{verbatim}
    % cp -r ${SMOOTH_HOME}/LocalTemplate /Users/CarlosSmith/MY_LOCAL
\end{verbatim}
}
...
{\tt
\begin{verbatim}
  % export SMOOTH_HOME=/Users/CarlosSmith/bandframework/software/SmoothEmulator
\end{verbatim}
}
