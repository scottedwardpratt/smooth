...
Next, one needs to edit the options file {\tt\$\{MY\_ANALYSIS\}/smooth\_data/smooth\_parameters/mcmc\_parameters.txt}. An example file is:
{\tt
\begin{verbatim}
