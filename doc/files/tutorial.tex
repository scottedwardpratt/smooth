...
\vspace*{-12pt}{\tt \begin{Verbatim}[commandchars=\\\{\}]
${MY_ANALYSIS}/figs/posterior% \textcolor{darkred}{ln -s ../../smooth_data/mcmc_trace/trace.txt .}
...
\vspace*{-12pt}{\tt \begin{Verbatim}[commandchars=\\\{\}]
${MY_ANALYSIS}/figs/resolvingpower% \textcolor{darkred}{ln -s ../../smooth_data/mcmc_trace/ResolvingPower.txt .}
${MY_ANALYSIS}/figs/resolving power% \textcolor{darkred}{python3 RP.py}
\end{Verbatim}
}\vspace*{-12pt}
...
\vspace*{-12pt}{\tt \begin{Verbatim}[commandchars=\\\{\}]
${MY_ANALYSIS}% \textcolor{darkred}{smoothy_testvsfullmodelalt}
...
\vspace*{-12pt}{\tt \begin{Verbatim}[commandchars=\\\{\}]
${MY_ANALYSIS}/figs/YvsY% \textcolor{darkred}{ln -s ../../smooth_data/fullmodel_testdata .}
