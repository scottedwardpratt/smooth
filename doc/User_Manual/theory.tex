...
\section{Underlying Theory of Smooth Emulator}\label{sec:theory}
...
\subsection{Mathematical Form of the Smooth Emulator}
...
\section{Theoretical Basis of Simplex Sampler}\label{sec:simplex}
...
\section{Tests of the Smooth Emulator using Simplex Sampler for Training}
